...
const Carousel = () => {
  return (
    <>
      ...
      <div className="md:hidden overflow-hidden w-full px-4 py-8 bg-white">
        {/* Texto principal */}
        ...
        <div className="overflow-hidden w-full mt-6 relative">
          ...
          <div
            className="flex animate-carousel-mobile space-x-4"
            style={{
              width: `${businesses.length * 250}px`,
            }}
          >
        ...
        <div className="flex justify-center mt-6">
          <button className="bg-red-500 text-white px-4 py-3 rounded-full font-semibold shadow-md w-full max-w-xs text-sm">
            Registra tu negocio
          </button>
        </div>
      </div>
      ...
      <div className="hidden md:block overflow-hidden w-full max-w-5xl mx-auto mt-20 px-4 relative">
        {/* Texto principal */}
        <div className="text-center">
      ...
      <style>
        {`
          ...
          @keyframes carousel-mobile {
            ...
            100% {
              transform: translateX(-${businesses.length * 250}px);
            }
          }
          .animate-carousel-mobile {
            animation: carousel-mobile 30s linear infinite;
          }
        `}
      </style>
    </>
