...
const RegistrationPromo = () => {
  return (
    <>
      ...
      <div className="md:hidden bg-white px-4 py-8">
        <div className="flex flex-col items-center">
          <img
            src={Porcentage}
            alt="Porcentage"
            className="w-full max-w-xs object-contain my-4"
          />
          ...
          <div className="flex flex-col gap-4 w-full">
            <button className="bg-red-500 text-white px-6 py-3 rounded-full font-semibold shadow-md w-full">
              Regístrate gratis
            </button>
            <button className="bg-white text-base px-6 py-3 rounded-full font-semibold shadow-md w-full border border-gray-200">
      ...
      <div className="hidden md:block max-w-4xl mx-auto p-6 mt-14">
        {/* Contenedor flex para la imagen y el texto, desplazado un poco a la izquierda */}
        <div className="flex flex-row items-start gap-8 -ml-24">
          ...
          <div className="flex-1 mt-32">
            ...
            <p className="text-gray-600 text-base mb-4">
              Unirte es fácil, y aprovechar tus compras aún más. Haz que cada
              peso cuente,{" "}
              <span className="font-semibold">
                haz que cada visita valga la pena.
              </span>
