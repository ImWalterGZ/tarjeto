  ...
  return (
    <>
      ...
      <div className="md:hidden bg-white px-8 py-8">
        <h2 className="text-3xl font-bold text-gray-800 leading-tight text-center mb-6">
          Las promos que la{" "}
        ...
        <div className="flex flex-col gap-4 mb-8">
          {promotions.map((promo, index) => (
            <div
              key={index}
              className={`p-4 rounded-lg bg-white flex items-center gap-4 border-2 shadow-md ${promo.borderColor}`}
            >
              {/* Imagen del negocio */}
              <img
                src={promo.image}
        ...
        <div className="flex justify-center">
          <button className="bg-red-500 text-white px-6 py-3 rounded-full font-semibold shadow-md w-full max-w-xs">
          ...
          {promotions.map((promo, index) => (
            <div
              ...
              className={`absolute w-96 p-4 rounded-lg bg-white flex items-center gap-4 transition-all duration-300 
                ...
                ${promo.position} ${
                hoveredIndex !== index ? promo.zIndex : ""
              }`}
