...
function App() {
  return (
    <div className="bg-red-primary w-screen h-screen flex flex-col font-poppins">
      <img src={logo} className="w-32 py-2 self-center my-2" />
      <div className="flex flex-row h-full items-center">
        <NavbarDashboard />
        <div className="bg-white  h-full py-5 rounded-tl-2xl rounded-tr-2xl w-11/12 flex  flex-col md:flex-row justify-between">
          <LeftPane />
          <RightPane />
        </div>
